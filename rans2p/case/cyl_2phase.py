...
from . import cyl_2phase_bc as custom_bc
...
bc_wall   = { 'method': custom_bc.noSlip }
bc_slip   = { 'method': std_bc.freeSlip }
bc_inlet  = { 'method': custom_bc.velocityInlet_rans2p, 
              'Vmag': Vmag,
              'sdf': IC_signed_distance,
              'fluid': fluid,
              'smoothing': mesh_nominal_spacing,
}
bc_outlet = { 'method': custom_bc.outflow_rans2p, 
              'sdf': IC_signed_distance,
              'fluid': fluid,
              'gravity': gravity,
              'waterLevel': waterLine_y,
