...
'''
filename = 'mesh/5415.tetgen'
bc_zone['interior'] = { 'meshtag': 1,  'condition': bc_interior }
bc_zone['ship']     = { 'meshtag': 2,  'condition': bc_wall }
bc_zone['x0']       = { 'meshtag': 3,  'condition': bc_inlet }
bc_zone['x1']       = { 'meshtag': 4,  'condition': bc_outlet }
bc_zone['y0']       = { 'meshtag': 5,  'condition': bc_wall }
bc_zone['y1']       = { 'meshtag': 6,  'condition': bc_wall }
bc_zone['z0']       = { 'meshtag': 7,  'condition': bc_wall }
...
bc_zone['y0']       = { 'meshtag': 4,  'condition': bc_wall }
